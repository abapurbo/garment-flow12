...
const Navbar = () => {
    ...
    return (
        <div className="fixed md:top-4 left-1/2 -translate-x-1/2 container mx-auto  md:px-10 z-50">
                ...
                <div className="flex items-center">
                    <div className="drawer lg:drawer-open">
                        ...
                        <div className="drawer-content flex items-center ">
                            <label htmlFor="main-drawer" className="md:hidden">
                        ...
                        <div className="drawer-side z-50">
                            ...
                            <aside className="w-72 min-h-full bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 p-6">
                        ...
                        <div className="dropdown dropdown-end">
                            ...
                            >
                                ...
                                <li>
                                    <button
                                        onClick={logoutUser}
                                        className="flex items-center font-semibold text-xl gap-2  text-red-500 bg-red-100 "
                                    >
                                        <FaSignOutAlt />
                                        Logout
                                    </button>
