  ...
  return (
    <div className="pt-34 pb-16 px-4 md:px-16 bg-gray-50 dark:bg-gray-900 min-h-screen container mx-auto">
      ...
      <div className="mb-10 flex flex-col md:flex-row justify-between items-center gap-4 px-10">
        <h1 className='text-2xl text-blue-500 dark:text-purple-600 font-bold'>({totalProducts}) Products Found</h1>
      ...
      {/* Pagination */}
      {
        products.length > 0 && (
          ...
          dark:bg-purple-100 dark:text-purple-700 dark:hover:bg-purple-600 dark:hover:text-white
